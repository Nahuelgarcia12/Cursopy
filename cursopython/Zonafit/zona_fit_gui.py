...
class App(tk.Tk):
  ...
  def guardar_cliente(self):
      ...
      if self.id_cliente is None:
       ...
       showinfo(title='agregar',message='Cliente agregado correctamente')
          ...
          showinfo(title='actualizar',message='Cliente actualizado correctamente')
      #volvemos  s mostrar la tabla
      self.recargar_datos()
  ...
  def eliminar_cliente(self):
    if  self.id_cliente is None:
        showinfo(title='atencion',message='debe seleccionar el cliente a eliminar')
    else:
        cliente=Cliente(id=self.id_cliente)
        cliente_dao.ClienteDAO.eliminar(cliente)
        showinfo(title='eliminado',message='Cliente eliminado correctamente')
        self.recargar_datos()
